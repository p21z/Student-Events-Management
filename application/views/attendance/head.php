...
<ul class="nav nav-tabs mt-5">
    ...
    <li class="nav-item">
        <a class="nav-link<?php if($this->session->userdata('nav_active')==='All'){?> active<?php } ?>" aria-current="page" href="<?=base_url()?>attendance/all/<?=$url_id?>">All</a>
    </li>
    <li class="nav-item">
    <a class="nav-link <?php if($this->session->userdata('nav_active')==='Present'){?> active<?php } ?>" aria-current="page" href="<?=base_url()?>attendance/present/<?=$url_id?>">Present</a>
    </li>
    <li class="nav-item">
    <a class="nav-link <?php if($this->session->userdata('nav_active')==='Late'){?> active<?php } ?>" aria-current="page" href="<?=base_url()?>attendance/late/<?=$url_id?>">Late</a>
    </li>
    <li class="nav-item">
    <a class="nav-link <?php if($this->session->userdata('nav_active')==='Absent'){?> active<?php } ?>" aria-current="page" href="<?=base_url()?>attendance/absent/<?=$url_id?>">Absent</a>
    </li>
