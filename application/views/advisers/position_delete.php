    ...
    <div class="container-fluid">
        ...
        <div class="card shadow w-50">
            ...
            <div class="card-body">
                ...
                <br><br>
                <form method="post" action="<?=base_url()?>advisers/position_delete/<?=$off_id?>">
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <a href="<?=base_url()?>advisers/officer_details/<?=$user_id?>" class="btn btn-danger btn-circle btn-md">
                        NO
                    </a>
                </form>
            </div>
