    ...
    ?>
        <form method="post" action="<?=base_url()?>profile">
                ...
                <div class="" style="">
                    ...
                    <input type="text" name="firstname" class="form-control form-control-user add-input" autocomplete=off value="<?=$firstname?>" placeholder="Firstname" required>

                    <input type="text" name="lastname" class="form-control form-control-user add-input" autocomplete=off value="<?=$lastname?>" placeholder="Lastname" required>

                    <input type="email" name="email" class="form-control form-control-user add-input" autocomplete=off value="<?=$email?>" placeholder="Email" required>

                    <input type="number" name="contact_no" class="form-control form-control-user add-input" autocomplete=off value="<?=$contact_no?>" placeholder="Contact no" required>           
                ...
                <?php
                    ...
                    {
                ?>
                    <input type="number" name="year_level" class="form-control form-control-user add-input" autocomplete=off value="<?=$year_level?>" placeholder="Year Level" required>
                    ...
                    <input type="text" name="section" class="form-control form-control-user add-input" autocomplete=off value="<?=$section?>" placeholder="Section">
                <?php
                    }
                ?>
