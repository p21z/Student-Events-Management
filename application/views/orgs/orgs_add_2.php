...
<div align=center>
    <div class="card mb-4 w-75">
        ...
        <form method="post" id="sectionForm" action="<?=base_url()?>organizations/organizations_add_2">
            ...
            &nbsp;&nbsp;
            <a href="<?=base_url()?>organizations/organizations_add" class="btn btn-dark btn-icon-split" style=" margin-top:3%; margin-bottom: 5%">
                <span class="icon text-white-50">
