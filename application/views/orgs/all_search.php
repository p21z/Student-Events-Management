    ...
    <div class="card shadow mb-4">
        <div class="card-header">
            ...
            <ul class="nav nav-tabs card-header-tabs">
                <li class="nav-item">
                    <a class="nav-link" aria-current="true" href="<?=base_url()?>organizations">Active</a>
                </li>
                <li class="nav-item">
        ...
        <div class="card-body">
            ...
            <div class="top-card mb-4 mt-2">
                ...
                <form method=post action="<?=base_url()?>organizations/all_search" autocomplete="off"
            ...
            <hr>
                ...
                $orgs_count=all_orgs_search_count($this->session->userdata('search'));
                
                if ($orgs_count==0)
                {
                    echo '<span class="ml-3"><i>No results for<b> "'.$this->session->userdata('search').'"</b></i></span>';
                } else
                {
                    echo '<span class="ml-3"><i>Results for<b> "'.$this->session->userdata('search').'"</b></i></span><br><br>';
                }

                $orgs_data=all_orgs_search($this->session->userdata('search'));
