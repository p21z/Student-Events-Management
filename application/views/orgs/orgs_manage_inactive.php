    ...
    <div class="card shadow mb-4">
        <div class="card-header">
            ...
            <ul class="nav nav-tabs card-header-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="true" href="<?=base_url()?>organizations/inactive">Inactive</a>
                </li>
                <li class="nav-item">
        ...
        <div class="card-body">
            ...
            <div class="top-card mb-4 mt-2">
                ...
                <form method=post action="<?=base_url()?>organizations/inactive" autocomplete="off"
            ...
            <hr>
                ...
                $orgs_data=get_where_not_2_custom($table_name, 'org_category', 'dean', 'Archive', 0);
