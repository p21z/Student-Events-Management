...
<div class="col-12">  <!-- start div container -->
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="mb-0 text-gray-800"><?=$event_name?><br>
      <span style="font-size: 24px;">Date:
        <?php
        ...
        <span style="font-size: 24px; margin-left: 50px;">Date:
        <?php
            echo $venue;
        ?>
        </span>
...
?>
  ...
  <div class="row">
    ...
    <div class="p-4 pt-5 card" style="width: 49.5%; margin-right: .5%; margin-bottom: .5%;" >
      <div>
        <canvas id="myChartQ1" class="col-12" style="width:100%; max-height: 500px;" ></canvas>
      </div> 
      <div class="card mt-2">
  ...
  <div class="row">
    ...
    <div class="p-4 pt-5 card" style="width: 49.5%; margin-right: .5%;" >
      <div>
    ...
    <div class="p-4 pt-5 card" style="width: 49.5%; margin-left: .5%;">
      <div>
