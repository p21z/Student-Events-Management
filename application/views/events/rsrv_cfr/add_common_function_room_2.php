<div align=center>
    <div class="card mb-4 w-75">
        ...
        <form method="post" action="<?=base_url()?>events/add_common_function_room_2/<?=$url_id?>">
            ...
            &nbsp;&nbsp;
            <a href="<?=base_url()?>events/add_common_function_room/<?=$this->session->userdata('url_id')?>/<?=$this->session->userdata('url_id_2')?>" class="btn btn-dark btn-icon-split" style=" margin-top:3%; margin-bottom: 5%">
                <span class="icon text-white-50">
