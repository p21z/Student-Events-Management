...
class Advisers extends CI_Controller {
	...
	function index()
	{
		...
		$this->load->view('advisers/adviser_manage');
    ...
    function adviser_details()
	{
        ...
        $this->load->view('must/perfect_function');
        $this->load->view('must/header');
		$this->load->view('advisers/adviser_details', $url_info);
        $this->load->view('must/footer');
	}
    ...
    function position_add()
    {
        ...
        $this->load->view('must/perfect_function');
        $this->load->view('must/header');
		$this->load->view('advisers/position_add');
        $this->load->view('must/footer');
    ...
    {
        $this->load->view('must/perfect_function');
        $this->load->view('advisers/position_add_proc');
        // $this->users_session_unset();
		redirect('/advisers/adviser_details/'.$this->session->userdata('user_id'));
    }
    ...
    {   
        ...
        $this->load->view('must/perfect_function');
        $this->load->view('must/header');
        $this->load->view('advisers/position_edit', $url_info);
        $this->load->view('must/footer');
    ...
    {
        $this->load->view('must/perfect_function');
        $this->load->view('advisers/position_edit_proc');
        // $this->users_session_unset();
		redirect('/advisers/officer_details/'.$this->session->userdata('user_id'));
    }
    ...
    {   
        ...
        $this->load->view('must/perfect_function');
        $this->load->view('must/header');
        $this->load->view('advisers/position_delete', $url_info);
        $this->load->view('must/footer');
        $this->form_validation->set_rules('user_id','user_id ID','required');
        if ($this->form_validation->run() == TRUE)
        {
            $this->officer_session_2();
            redirect('/advisers/position_delete_proc');
        }
    ...
    {
        $this->load->view('must/perfect_function');
        $this->load->view('advisers/position_delete_proc');
        // $this->users_session_unset();
		redirect('/advisers/adviser_details/'.$this->session->userdata('user_id'));
    }
